    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center">اضافة معلومات الموظف</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" placeholder="ادخل اسم الموظف" name="em_fullname" list="expense" class="form-control input-custom" id="default" required>
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" placeholder="حساب المستخدم باللغة الأنقليزيةٍ"em_username" class="form-control input-custom" required>
                    </div>
                    <label class="control-label col-sm-4">حساب المستخدم</label>
                  </div>
                  <div class="form-group">ٍ
                    
                    <div class="col-sm-6">
                      <input type="email" placeholder="ادخل بريد الموظف" name="em_email" class="form-control input-custom" required>
                    </div>
                    <label class="control-label col-sm-4">البريد الالكتروني</label>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="btn btn-success-custom">اضافة</button>
                    </div>
                    <div class="col-sm-3">
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-success btn-menu" data-toggle="modal" data-target="#myModal">اضافة موظف جديد</button>
                </div>
              <?php } ?>
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            <li><a href="manage-admin.php">اعدادات مدير النظام</a></li>
            <li class="active"><a href="admin-manage-user.php">اعدادات حساب الموظفين</a></li>
          </ul>
          <div class="gap"></div>
