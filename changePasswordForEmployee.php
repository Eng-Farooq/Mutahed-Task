		...
		<div class="well" style="position:relative;top:20vh">
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading" style="background: orange;">
			    <h2 class="text-center">الرجاء تغير كلمة</h2>
			  </div>
			  ...
			  <div class="form-group">
			    <input type="password" class="form-control" placeholder="اعادة كتابة كلمة المرور" name="re_password" required/>
			  </div>
			  <button type="submit" name="change_password_btn" class="btn btn-default pull-right">تغير كلمة المرور</button>
			</form>
		</div>
	</div>
</div>
