        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">تعديل المهمة </h3><br>
                        ...
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <input type="text" placeholder="عنوان  المهمة" id="task_title" name="task_title" list="expense" class="form-control" value="<?php echo $row['t_title']; ?>" <?php if($user_role != 1){ ?> readonly <?php } ?> val required>
			                    </div>
			                  ...
			                  <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <textarea name="task_description" id="task_description" placeholder="وصف المهمة" class="form-control" rows="5" cols="5"><?php echo $row['t_description']; ?></textarea>
			                    </div>
			                   ...
			                   <div class="form-group">
			                    <div class="col-sm-7">
			                      <select class="form-control" name="status" id="status">
			                      	<option value="0" <?php if($row['status'] == 0){ ?>selected <?php } ?>>غير مكتملة</option>
			                      	<option value="1" <?php if($row['status'] == 1){ ?>selected <?php } ?>>جاري العمل</option>
			                      	<option value="2" <?php if($row['status'] == 2){ ?>selected <?php } ?>>مكتملة</option>
			                      </select>
			                    </div>
								<label class="control-label col-sm-5">الحالة</label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_task_info" class="btn btn-success-custom">حدث </button>
                              </div>
                            </div>
                          </form> 
                        </div>
